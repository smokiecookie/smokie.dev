...
modDatetime: 2025-04-21T04:14:51.000+06:00
...
import {
  valorantMinimapSettings,
  rawAccelConfig,
  valorantGraphicsSettings,
  valorantStats
...
<Image src={rawAccelConfig} loading="eager" />
I have raw-accel turned on. Angle snapping is set
to `10`. In-game sensitivity is `0.3`. Also You can find my favorite crosshairs
[here](/posts/valorant-crosshair-database)
...
<Image src={valorantMinimapSettings} />
...
## Graphics Settings
<Image src={valorantGraphicsSettings} />

## Turn On These Stats

<Image src={valorantStats} />
